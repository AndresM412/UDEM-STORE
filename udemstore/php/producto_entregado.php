			...
			$tabla.='
			   ...
			   $tabla.='</p>
			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                <strong>NOMBRE:</strong> '.$rows['producto_nombre'].' <strong>STOCK:</strong> '.$rows['producto_stock'].'
			              </p>
			            </div>
			            <div class="has-text-right">
			                <a href="index.php?vista=producto_restado&product_id_up='.$rows['producto_id'].'" class="button is-success is-rounded is-small">Entregar</a>
			            </div>
			        </div>
			    </article>
