...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-10-2022 a las 04:52:35
...
CREATE DATABASE IF NOT EXISTS `pdo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci;
USE `pdo`;
...
('root', '2022-09-23 04:11:43', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
...
--
DROP DATABASE IF EXISTS `udemstore`;
...
CREATE TABLE `categoria` (
  `categoria_id` int(7) NOT NULL,
  `categoria_nombre` varchar(50) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `categoria_ubicacion` varchar(150) COLLATE utf8mb4_spanish2_ci NOT NULL
...
CREATE TABLE `producto` (
  `producto_id` int(20) NOT NULL,
  `producto_codigo` varchar(40) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `producto_nombre` varchar(40) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `producto_cantidad` int(40) NOT NULL,
  `producto_valor` decimal(30,2) NOT NULL,
  `producto_cantidad_entregar` int(250) NOT NULL,
  `producto_foto` varchar(500) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `categoria_id` int(7) NOT NULL,
  `usuario_id` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
CREATE TABLE `usuario` (
  ...
  `usuario_usuario` varchar(40) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `usuario_contraseña` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
